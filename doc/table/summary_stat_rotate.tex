...
\begin{minipage}{23cm}
  \scriptsize
  Notes: The table presents summary statistics of personal income, family income, schooling, and college enrollment rates across different age groups in shale and non-shale states. The weighted population is based on the IPUMS American Community Survey (ACS) data's personal weights (PERWT) and household weights (HHWT). 
