...
\begin{frame}{IPUMS  ACS  Data}
    ...
    \end{itemize}
\input{table/summary_stat_tiny_concise.tex}
\end{frame}
%------------------------------------------------
...
\begin{itemize}
  \item  Concern:  selective  immigration  from  non-shale  to  shale  states  may  bias  estimates  upward.
  \item  Disproof:  shale  states  had  more  outflow  than  inflow  post-treatment.\hyperlink{sec:migration}{\beamergotobutton{Details}}
\end{itemize}
\end{frame}
%------------------------------------------------
...
Theoretically,  what  this  enables  us,  if  we're  not  short  on  power,  is  to  see  
...
\begin{columns}
    ...
    \begin{table}[h]
        ...
        \hline
              &$t_1$&$t_2$&$t_3$&$t_4$&$t_5$  \\  \hline
              TX($g_1$)&\textcolor{red!60}{o}&\textcolor{red!60}{o}&\textcolor{red!60}{o}&\textcolor{red!60}{o}&\textcolor{red!60}{o}  \\  \hline
              AR($g_2$)&x&\textcolor{red!60}{o}&\textcolor{red!60}{o}&\textcolor{red!60}{o}&\textcolor{red!60}{o}  \\  \hline
              OK($g_2$)&x&\textcolor{red!60}{o}&\textcolor{red!60}{o}&\textcolor{red!60}{o}&\textcolor{red!60}{o}  \\  \hline
              AL($g_4$)&x&x&x&\textcolor{red!60}{o}&\textcolor{red!60}{o}  \\  \hline
              LA($g_4$)&x&x&x&\textcolor{red!60}{o}&\textcolor{red!60}{o}  \\  \hline
              PA($g_4$)&x&x&x&\textcolor{red!60}{o}&\textcolor{red!60}{o}  \\  \hline
              WV($g_4$)&x&x&x&\textcolor{red!60}{o}&\textcolor{red!60}{o}  \\  \hline
              Oth.  St.($g_\infty$)&x&x&x&x&x  \\  \hline
        \end{tabular}
        \caption{\footnotesize  Actual  Rollout  $(\hat\tau)$}
        %  \label{tab:my_label}
    \end{table}

    \column{0.3\linewidth}  %2
    \begin{table}[h]
        \centering
        \tiny
        \begin{tabular}{|c|c|c|c|c|c|}
        \hline
              &$t_1$&$t_2$&$t_3$&$t_4$&$t_5$  \\  \hline
              {\color{blue}AR}($g_1$)&\textcolor{red!60}{o}&\textcolor{red!60}{o}&\textcolor{red!60}{o}&\textcolor{red!60}{o}&\textcolor{red!60}{o}  \\  \hline
              {\color{blue}WV}($g_2$)&x&\textcolor{red!60}{o}&\textcolor{red!60}{o}&\textcolor{red!60}{o}&\textcolor{red!60}{o}  \\  \hline
              OK($g_2$)&x&\textcolor{red!60}{o}&\textcolor{red!60}{o}&\textcolor{red!60}{o}&\textcolor{red!60}{o}  \\  \hline
              {\color{blue}TX}($g_4$)&x&x&x&\textcolor{red!60}{o}&\textcolor{red!60}{o}  \\  \hline
              LA($g_4$)&x&x&x&\textcolor{red!60}{o}&\textcolor{red!60}{o}  \\  \hline
              PA($g_4$)&x&x&x&\textcolor{red!60}{o}&\textcolor{red!60}{o}  \\  \hline
              {\color{blue}AL}($g_4$)&x&x&x&\textcolor{red!60}{o}&\textcolor{red!60}{o}  \\  \hline
              Oth.  St.($g_\infty$)&x&x&x&x&x  \\  \hline
        \end{tabular}
        \caption{\footnotesize  Permutation  1$(\hat\tau_{1})$}
        %  \label{tab:my_label}
    \end{table}

    \column{0.3\linewidth}  %3
    \begin{table}[h]
        \centering
        \tiny
        \begin{tabular}{|c|c|c|c|c|c|}
        \hline
              &$t_1$&$t_2$&$t_3$&$t_4$&$t_5$  \\  \hline
              {\color{blue}NC}($g_1$)&\textcolor{red!60}{o}&\textcolor{red!60}{o}&\textcolor{red!60}{o}&\textcolor{red!60}{o}&\textcolor{red!60}{o}  \\  \hline
              AR($g_2$)&x&\textcolor{red!60}{o}&\textcolor{red!60}{o}&\textcolor{red!60}{o}&\textcolor{red!60}{o}  \\  \hline
              {\color{blue}  CA}($g_2$)&x&\textcolor{red!60}{o}&\textcolor{red!60}{o}&\textcolor{red!60}{o}&\textcolor{red!60}{o}  \\  \hline
              {\color{blue}TX}($g_4$)&x&x&x&\textcolor{red!60}{o}&\textcolor{red!60}{o}  \\  \hline
              LA($g_4$)&x&x&x&\textcolor{red!60}{o}&\textcolor{red!60}{o}  \\  \hline
              PA($g_4$)&x&x&x&\textcolor{red!60}{o}&\textcolor{red!60}{o}  \\  \hline
              WV($g_4$)&x&x&x&\textcolor{red!60}{o}&\textcolor{red!60}{o}  \\  \hline
              {\color{blue}Oth.  St.}($g_\infty$)&x&x&x&x&x  \\  \hline
        \end{tabular}
        \caption{\footnotesize  Permutation  2$(\hat\tau_{2})$}
        %  \label{tab:my_label}
    \end{table}
\end{columns}
\end{frame}
